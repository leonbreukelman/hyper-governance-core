...
<!-- BEGIN_STACK_SUMMARY -->
- **Python Version:** 3.11
- **Allowed Libraries:** `pyyaml`, `jsonschema`, `click`, `rich`, `pytest`, `pytest-cov`, `ruff`, `mypy`
- **Banned Libraries:** `pickle`, `telnetlib`, `eval`, `exec`, `os.system`
- **Required Tools:** `ruff`, `mypy`, `pytest`
<!-- END_STACK_SUMMARY -->
...
- **Banned Libraries:** `pickle`, `telnetlib`, `eval`, `exec`, `os.system`
- **Forbidden Patterns:** `eval(`, `exec(`, `os.system(`, `yaml.load(`
...
- **Minimum Reviewers:** 1
- **Required Checks:** `tests`, `validators`, `linting`, `coverage`
<!-- END_PROCESS_RULES -->
